...
[`@aws-sdk/client-sagemaker-metrics`](https://www.npmjs.com/package/@aws-sdk/client-sagemaker-metrics/v/3.1090.0).
...
- @aws-sdk/client-sagemaker-metrics - [https://cloud-sdk-builds.github.io/?sdk=client-sagemaker-metrics](https://cloud-sdk-builds.github.io/?sdk=client-sagemaker-metrics)
- @aws-sdk/client-sagemaker-metrics v3.1090.0 - [https://cloud-sdk-builds.github.io/?sdk=client-sagemaker-metrics&version=3.1090.0](https://cloud-sdk-builds.github.io/?sdk=client-sagemaker-metrics&version=3.1090.0)
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-metrics@3.1090.0/index.min.mjs
```

SRI SHA Hash

```text
sha384-uytV7jGuSTZJBjVBu+aXCeWRhA3/oDU9YZGDrUqMFLUwn+V24T35AalYyhyco2cv
```
...
```text
https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-metrics/index.min.mjs
```
...
<script type="importmap">
      {
        "imports": {
            "@aws-sdk/client-sagemaker-metrics": "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-metrics@3.1090.0/index.min.mjs"
        },
          "integrity": {
            "https://cdn.jsdelivr.net/gh/cloud-sdk-builds/client-sagemaker-metrics@3.1090.0/index.min.mjs": "sha384-uytV7jGuSTZJBjVBu+aXCeWRhA3/oDU9YZGDrUqMFLUwn+V24T35AalYyhyco2cv"
        }
      }
</script>
```
...
<html lang="en">
      ...
      <body>
            <h1>Hello World!</h1>
            <script type="module">
                  import {  } from "@aws-sdk/client-sagemaker-metrics";
...
```
https://github.com/cloud-sdk-builds/client-sagemaker-metrics/blob/refs/tags/3.1090.0/LICENSE
```
